    ...
    <div className="min-h-screen bg-[#0a1f14] text-white pb-20">
      <div className="max-w-md mx-auto px-4 pt-6 space-y-5">
        ...
        <div className="bg-[#132d1f] border border-[#1e4a33] rounded-2xl p-5">
          ...
          <button className="w-full bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2">
            <Download size={14} />
            导出记录
          </button>
        </div>
